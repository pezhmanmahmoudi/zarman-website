        ...
        <div className={styles.layout}>
          <div className={styles.content}>
            ...
            <h1 className={`${styles.title} ${styles.hiddenOnLoad}`}>
              ...
              <span className={styles.tooltipWrapper}>
                ...
                <span className={styles.tooltipText}>
                  اولورو (<span className={styles.uluruEnText}>Uluru</span>) صخره‌ای مقدس و عظیم در قلب
                  استرالیاست؛ نمادی دیرینه از این سرزمین.
                </span>
              </span>{" "}
              تا دماوند
              <br />
            ...
            <p className={`${styles.subtitle} ${styles.hiddenOnLoad}`}>
              ما تلاش می‌کنیم با تمرکز بر سرعت، شفافیت و پشتیبانی همیشگی، تجربه ثبت و پیگیری درخواست‌های
              مالی را برای شما آسان‌تر، روشن‌تر و قابل‌اعتمادتر کنیم.
            </p>
                ...
                <div className={styles.ratesData}>
                  <div className={styles.rateCol}>
                    ...
                    <strong className={styles.value}>
                      {isLoading ? "---" : currentRates.sellAUD.toLocaleString("fa-IR")}
                  ...
                  <div className={styles.rateCol}>
                    ...
                    <strong className={styles.value}>
                      {isLoading ? "---" : currentRates.buyAUD.toLocaleString("fa-IR")}
                      <span className={styles.currency}>تومان</span>
                    </strong>
                  </div>
                </div>
